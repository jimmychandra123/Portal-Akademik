...
<div class="konten">
	<h2>Selamat Datang <?php echo $row['nama_dosen']; ?></h2><br>
	<div class="isikonten">
...
?>
	...
	<a href="viewpengumumandosen.php?id=<?php echo $row['kode_pengumuman'] ?>"><?php echo $row['judul_pengumuman'] ?>:  <?php echo $row['tanggal_kirim'] ?> <?php echo $row['jam'] ?></br>
				<hr></a><br><br>
<?php
	}
?>		
...
?>
	...
	<a href="viewpengumumandosen.php?id=<?php echo $row2['kode_pengumuman'] ?>"><?php echo $row2['judul_pengumuman'] ?>:  <?php echo $row2['tanggal_kirim'] ?> <?php echo $row2['jam'] ?></br>
				<hr></a><br><br>
	<?php
	}
	?>  <center><?php for ($i=1; $i<=$pages ; $i++){ ?>
...
?>	
	<a href="viewpengumumandosen.php?id=<?php echo $row3['kode_pengumuman'] ?>"><?php echo $row3['judul_pengumuman'] ?>:  <?php echo $row3['tanggal_kirim'] ?> <?php echo $row3['jam'] ?></br>
				<hr></a><br><br>
	<?php
	}
	?>	 <center><?php for ($i=1; $i<=$pages ; $i++){ ?>
