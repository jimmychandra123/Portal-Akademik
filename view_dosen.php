...
<div class="konten">
  ...
  $sql1 = "SELECT dosen.*, programstudi.nama_prodi FROM dosen INNER JOIN programstudi ON dosen.kode_prodi = programstudi.kode_prodi WHERE kode_dosen = '$id'";
  ...
  <a href="manage_dosen.php">Kembali</a>
      ...
      <h2>Form View Data Dosen </h2>

          <form method="post" >
            <table class="tabel" >
   <tbody><tr width="150"> 
      <th>Kode Dosen</th>
            <td><?php echo $row1['kode_dosen']; ?></td>
   </tr> 
         <tr> 
            <th>Nama</th>
