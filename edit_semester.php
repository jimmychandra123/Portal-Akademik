...
<div class="konten">
  ...
  $sql1 = "SELECT * FROM semester WHERE kode_semester = '$id'";
  ...
  <a href="manage_semester.php">Kembali</a>
      ...
      <h2>Form Edit Data Semester </h2>
         ...
         <tbody>
          <tr width="150">
            <th>Kode Dosen :</th>
          <td><input type="text" name="kode_semester" value="<?php echo $row1['kode_semester'] ?>" size="70" disabled></td>
          </tr>
            <th>Semester :</th>
...
<?php 
 ...
 $sql2 = "UPDATE semester SET  semester='$semester' WHERE kode_semester='$id'";
