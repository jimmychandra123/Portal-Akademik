...
<div class="konten">
	...
	<div class="isikonten">
		<p>Keterangan : </br>
			Manage Data Kelas, hanya dapat digunakan oleh admin untuk menambah dan mengedit data Kelas di Universitas JimmyChandra.</p>
	</div>
	...
	<div class="tabel">
	<a href="add_kelas.php">Tambah Kelas</a>
	</div>
	<h2>Form List Kelas</h2>
	<?php 
      $dsql = "SELECT kelas.*, programstudi.nama_prodi, semester.semester FROM kelas INNER JOIN programstudi ON kelas.kode_prodi = programstudi.kode_prodi INNER JOIN semester ON kelas.kode_semester = semester.kode_semester ORDER BY kelas.kode_kelas ASC";
...
?>
			<tr >
				...
				<td><a href="edit_kelas.php?id=<?php echo $row['kode_kelas'] ?>"> &ensp; Edit</a> || <a href="delete_kelas.php?id=<?php echo $row['kode_kelas'] ?>">Delete</a></td>
