...
if(!isset($_SESSION["DosenID"]))
 ...
 $sql = "SELECT * FROM dosen WHERE kode_dosen = '".$_SESSION['DosenID']."'";
			...
			<div class="card-body">
				<form action="#" method="post">
					<div class="input-group form-group">
						...
						<p>NPM :&ensp;&ensp;&ensp;</p><input type="text" class="form-control" name="npm" value="<?php echo $row['kode_dosen'];?>">
...
<?php
  ...
  $passwordbaru = $_POST['passwordbaru'];
  		...
  		if ($passwordbaru === "") {
  			echo "<script> alert('Silahkan Input Password Baru Anda!'); window.location.href='halaman_changepassdosen.php' </script>";;
  		}
  		if($passwordbaru){
