...
<div class="konten">
	...
	<div class="tabel">
	<a href="add_programstudi.php">Tambah Program Studi</a>
	</div>
	<h2>Form List Program Studi</h2>
	<?php 
      $dsql = "SELECT * FROM `programstudi` ORDER BY kode_prodi ASC";
...
?>
			<tr >
				...
				<td><a href="edit_programstudi.php?id=<?php echo $row['kode_prodi'] ?>"> &ensp; Edit</a> || <a href="delete_programstudi.php?id=<?php echo $row['kode_prodi'] ?>">Delete</a></td>
