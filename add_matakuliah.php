 ...
 -->
  ...
  <table class="tabel" >
   <tbody><tr width="150">  
            ...
            <td><input name="kode_matkul" autocomplete="off" type="text" size ="70"></input></td>
         </tr>
       <tr>

      <th>Nama Matakuliah :</th>
            <td><input name="nama_matkul" autocomplete="off" type="text" size ="70"></input></td>
         </tr>
...
if ($kode_matkul === "") {
      echo "<script> alert('Silahkan input Kode Matkul!');</script>";
      ...
      echo'<META HTTP-EQUIV="Refresh" CONTENT="0; URL=manage_jadwal.php">';
  }if($kode_matkul && $nama_matkul && $kode_prodi && $kode_semester && $jumlah_sks) {
  
    $query = mysqli_query($DBConn,"INSERT INTO matakuliah(kode_matkul, nama_matkul, kode_prodi, kode_semester, jumlah_sks) VALUES ('$kode_matkul','$nama_matkul','$kode_prodi','$kode_semester','$jumlah_sks')");
    ...
    if($query){
     ...
     echo "<script> alert('Koneksi Gagal!');</script>";
      echo'<META HTTP-EQUIV="Refresh" CONTENT="0; URL=add_matakuliah.php">';
  }
}else{
