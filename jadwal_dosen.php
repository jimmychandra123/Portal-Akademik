...
<div class="konten">
  <h2>Lihat Jadwal Mengajar</h2>
 	 <div class="isikonten">
    	<p>Keterangan : </br>
      	 Lihat Jadwal Mengajar, Fitur ini dapat digunakan oleh dosen untuk melihat Jadwal dimana dosen mengajar di Universitas JimmyChandra.</p>
 	 </div>
