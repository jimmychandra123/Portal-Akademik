...
<!-- 		<table class="tabel">
 ...
 -->
   ...
   <tbody><tr width="150">  
            ...
            <td><input name="kode_pengumuman" autocomplete="off" type="text" size ="70"></input></td>
         </tr>
      <tr>
      ...
      <th>Judul Pengumuman :</th>
            <td><input name="judul_pengumuman" autocomplete="off" type="text" size ="70"></input></td>
         </tr>
 	
	<tr>
      <th>Tanggal Kirim :</th>
            <td><input name="tanggal_kirim" value="<?php echo $tanggal;?>" autocomplete="off" type="date" size ="70" disabled></input></td>
    </tr>       
      <th>Jam Kirim :</th>
            <td><input name="jam_kirim" value="<?php echo $jam;?>" autocomplete="off" type="time" size ="70" disabled></input></td>
    </tr>       

     <th colspan=2>
     Isi Pengumuman : 
    <textarea name="isipengumuman" placeholder="Silahkan Ketik isi pengumuman disini..." style="margin: 0px; width: 679px; height: 168px;"></textarea>	
	 </th>
...
if(isset($_POST['submit']))
{
  ...
  if ($kode_pengumuman === "") {
      echo "<script> alert('Silahkan input Kode Pengumuman!');</script>";
      ...
      echo'<META HTTP-EQUIV="Refresh" CONTENT="0; URL=manage_pengumuman.php">';
  }if($kode_pengumuman && $kategori_pengumuman && $judul_pengumuman && $isipengumuman) {
  
  
    $query = mysqli_query($DBConn,"INSERT INTO pengumuman(kode_pengumuman, judul_pengumuman, isi_pengumuman, tanggal_kirim, kategori, jam) VALUES ('$kode_pengumuman','$judul_pengumuman','$isipengumuman','$tanggal_kirim','$kategori_pengumuman','$jam_kirim')");
    ...
    if($query){
     echo "<script> alert('Succesfully Added!');</script>";
      ...
      echo'<META HTTP-EQUIV="Refresh" CONTENT="0; URL=add_pengumuman.php">';
  }
}else{
