...
<div class="konten">
	...
	<h2>Form List Dosen</h2>
	<?php 
      $dsql = "SELECT dosen.*, programstudi.nama_prodi FROM dosen INNER JOIN programstudi ON dosen.kode_prodi = programstudi.kode_prodi Order BY dosen.kode_dosen ASC";
...
?>
			<tr>
				...
				<td><a href="view_dosen.php?id=<?php echo $row['kode_dosen'] ?>"> &ensp;View</a> || <a href="edit_dosen.php?id=<?php echo $row['kode_dosen'] ?>">Edit</a></td>
			</tr>
			<?php
		}
	}
